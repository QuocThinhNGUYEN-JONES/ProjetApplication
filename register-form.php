<?php
    ...
    if(!empty($_POST))
    {
        ...
        if(empty($phone)){
            $valid = false;
            $er_phone = "Le numéro de téléphone ne peut pas être vide";
        }
        // Vérification du mdp
        if(empty($mdp)){
            $valid = false;
            $er_mdp = "Le mail ne peut pas être vide";
        }
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black fw-bold">
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="student-card-number">Student card</label>
